...
# Create a list using `map` function with a dygraph plot of the number of
# sessions per date for every user profile separately
...
demand <- get_demand(sessions_profiles2, seq_dt, interval_mins)
